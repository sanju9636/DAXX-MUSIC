...
TAGMES = [ " **𝐇𝐞𝐲 𝐁𝐚𝐛𝐲 𝐊𝐚𝐡𝐚 𝐇𝐨🥱** ",
           " **𝗧𝘂𝗺 𝗻𝗲 𝗯𝗶𝗼 𝗰𝗼𝗺𝗽𝗹𝗲𝘁 𝗸𝗿 𝗹𝗶𝘆𝗮 🤨** ",
           " **𝗔𝗮𝗷 𝗸𝗼𝗻 𝘀𝗶 𝗰𝗹𝗮𝘀𝘀 𝗵𝗮𝗶😒** ",
           " **𝗡𝗼𝗯𝗶𝘁𝗮 𝗸𝗶 𝗴𝗳 𝗵𝗼 𝗻𝗮 𝘁𝘂𝗺 😅** ",
           " **𝗡𝗼𝗯𝗶𝘁𝗮 𝘀𝗲 𝗹𝗼𝘃𝗲 𝗸𝗿𝘁𝗲 𝗵𝗼😇** ",
           " **𝗡𝗼𝗯𝗶𝘁𝗮 𝗯𝗵𝘂𝘁 𝗮𝗰𝗵𝗮 𝗵𝗮𝗶☹️** ",
           " **𝐎𝐲𝐞 𝐒𝐨 𝐆𝐲𝐞 𝐊𝐲𝐚 𝐎𝐧𝐥𝐢𝐧𝐞 𝐀𝐚𝐨😊** ",
           " **𝐕𝐜 𝐂𝐡𝐚𝐥𝐨 𝐁𝐚𝐭𝐞𝐧 𝐊𝐚𝐫𝐭𝐞 𝐇𝐚𝐢𝐧 𝐊𝐮𝐜𝐡 𝐊𝐮𝐜𝐡😃** ",
           " **𝐊𝐡𝐚𝐧𝐚 𝐊𝐡𝐚 𝐋𝐢𝐲𝐞 𝐉𝐢..??🥲** ",
           " **𝗡𝗼𝗯𝗶𝘁𝗮 𝗸𝗶 𝗴𝗳 𝗸𝗮 𝗸𝘆𝗮 𝗻𝗮𝗺 𝗵𝗮𝗶😕** ",
           " **𝐆𝐡𝐚𝐫 𝐌𝐞 𝐒𝐚𝐛 𝐊𝐚𝐢𝐬𝐞 𝐇𝐚𝐢𝐧 𝐉𝐢🥺** ",
           " **𝐏𝐭𝐚 𝐇𝐚𝐢 𝐁𝐨𝐡𝐨𝐭 𝐌𝐢𝐬𝐬 𝐊𝐚𝐫 𝐑𝐡𝐢 𝐓𝐡𝐢 𝐀𝐚𝐩𝐤𝐨🤭** ",
           " **𝐎𝐲𝐞 𝐇𝐚𝐥 𝐂𝐡𝐚𝐥 𝐊𝐞𝐬𝐚 𝐇𝐚𝐢..??🤨** ",
           "**𝗧𝗲𝗿𝗶 𝗺𝘂𝗺𝘆 𝗸𝗼 𝗯𝗼𝗹𝘂𝗻𝗴𝗶 𝘁𝘂 𝘀𝘁𝘂𝗱𝘆 𝗻𝗵𝗶 𝗸𝗿𝘁𝗶😷** ",
           " **𝐌𝐞𝐫𝐢 𝐁𝐡𝐢 𝐒𝐞𝐭𝐭𝐢𝐧𝐠 𝐊𝐚𝐫𝐛𝐚 𝐃𝐨𝐠𝐞..??🙂** ",
           " **𝐀𝐚𝐩𝐤𝐚 𝐍𝐚𝐦𝐞 𝐊𝐲𝐚 𝐡𝐚𝐢..??🥲** ",
           " **𝗧𝗲𝗿𝗲 𝗽𝗮𝗽𝗮 𝗮𝗿𝗺𝘆 𝗺𝗲 𝗵𝗮𝗶🥳**",
           " **𝐍𝐚𝐬𝐭𝐚 𝐇𝐮𝐚 𝐀𝐚𝐩𝐤𝐚..??😋** ",
           " **𝐌𝐞𝐫𝐞 𝐊𝐨 𝐀𝐩𝐧𝐞 𝐆𝐫𝐨𝐮𝐩 𝐌𝐞 𝐊𝐢𝐝𝐧𝐚𝐩 𝐊𝐫 𝐋𝐨😍** ",
           " **𝗧𝗲𝗿𝗲 𝗽𝗮𝗽𝗮 𝗯𝘂𝗹𝗮 𝗿𝗵𝗲 𝘁𝗲𝗿𝗲 𝗸𝗼** ",
           " **𝐀𝐚𝐩𝐤𝐢 𝐏𝐚𝐫𝐭𝐧𝐞𝐫 𝐀𝐚𝐩𝐤𝐨 𝐃𝐡𝐮𝐧𝐝 𝐑𝐡𝐞 𝐇𝐚𝐢𝐧 𝐉𝐥𝐝𝐢 𝐎𝐧𝐥𝐢𝐧𝐞 𝐀𝐲𝐢𝐚𝐞😅😅** ",
           " **𝐌𝐞𝐫𝐞 𝐒𝐞 𝐃𝐨𝐬𝐭𝐢 𝐊𝐫𝐨𝐠𝐞..??🤔** ",
           " **𝐒𝐨𝐧𝐞 𝐂𝐡𝐚𝐥 𝐆𝐲𝐞 𝐊𝐲𝐚🙄🙄** ",
           " **𝗸𝗿𝗶𝘀𝗵𝗮𝗻 𝗸𝗮𝗻𝗵𝗮𝗶𝘆𝗮 𝗸𝗶 𝗴𝗳 𝗸𝗼𝗻 𝘀𝗶 𝗵𝗮𝗶😈** ",
